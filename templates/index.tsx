...
import { defaults as pageDefaults, resolvers as pageResolvers } from './pageResolvers';
...
const cache = options.makeCache ? options.makeCache({ cacheOptions }) : new InMemoryCache({ ...cacheOptions });
